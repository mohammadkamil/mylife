        ...
        <section class="register-photo" style="background-color: transparent;">
            <div class="form-container" style="margin-top: 40px;">
                ...
                <form method="post" action="afterRegister.html">
                    ...
                    <div class="form-group mb-3"><button class="btn btn-primary d-block w-100" type="submit" style="color: rgb(255,255,255);background-color: #00b5a8;">Crear cuenta</button></div><a class="already" href="login.html">Do not have account, Click here!</a>
                </form>
            </div>
        </section>
    </main>
